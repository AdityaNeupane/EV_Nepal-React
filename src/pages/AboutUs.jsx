  ...
  return (
    <>
      <div className="aboutus-section" id="aboutus">
        <h1 className="h1">Know the Story of EV-Nepal</h1>
        <br></br>
        <br></br>
        <p>
        ...
        <br></br>
        <p>
          At EV Nepal, our mission is to be everything about EV's. We strive to
          offer our customers the best possible experience, ensuring that
          <br></br> our customers always receive the best value for their money.
        </p>
        <br></br>
        <p>
          We envision a future where we see every vehicle as electric vehicle.
          Our commitment to Electric Vehicle movement drives us to<br></br>{" "}
          continually improve and set new standards.
        </p>
      </div>
    </>
  );
