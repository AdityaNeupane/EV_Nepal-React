...
const Ourjourney = () => {
  return (
    ...
    <h1 className='ourjourney-heading geologica-journey'>Our Journey</h1>
       ...
       <div className="ourjourney-para">
        ...
        <img src={meeting} alt="meeting" className='animate__animated  animate__fadeInDown' />
           ...
           <div className='ourjourney-para-text'>
            <h1 className='ourjourney-para-heading animate__animated   animate__fadeInUp geologica-journey'>   
