...
const Whatwedo = () => {
  return (
     ...
     <div className="whatwedo">
      ...
      <div className="upper-box">
        ...
        <div className="upper-left animate__animated animate__fadeInLeft">
         ...
         <h1 className='upper-left-heading animate__animated animate__bounceIn'> Latest News and Updates</h1>
        ...
        <h1 className='upper-middle-heading animate__animated animate__bounceIn'> EMI Calculator</h1>
       ...
       <h1 className='upper-right-heading animate__animated animate__bounceIn'> Comprehensive EV Listings </h1>
      ...
      <div className="middle-box">
        ...
        <h1 className='middle-left-heading animate__animated animate__bounceIn'>Consult with Our Experts </h1>
     ...
     <h1 className='middle-right-heading animate__animated animate__bounceIn'> Nearby Charging Stations Locator </h1>
     ...
     <h1 className='lower-left-heading animate__animated animate__bounceIn'>Brand Exploration </h1>
     <p className='lower-left-para animate__animated animate__fadeInUp'> A dedicated section to explore different brands offering electric vehicles in Nepal, making it easier for users to compare and choose the best option.  </p>
      ...
      <h1 className='lower-middle-heading animate__animated animate__bounceIn'> Price Comparison Tool </h1>
     ...
     <h1 className='lower-right-heading animate__animated animate__bounceIn'>   Expert Reviews and Ratings </h1>
